    ...
    return (
        <>
            ...
            <div className={infoClasses}>
                ...
                <p className="disclaimer">* In practice, the theme would change and the gallery would be reset every 24 hours. For demonstration purposes, the theme will change every 5 minutes, and the gallery will have some pre-loaded sample images matching that theme. Additionally, in practice the themes would not repeat (at least not very often), but for demonstration purposes there are currently 3 themes and the app will rotate between these every 5 minutes.</p>
